            ...
            <table class="menu-container" border="0">
                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                ...
                                <td style="padding:0px;margin:0px;">
                                    ...
                                    <p class="profile-subtitle">taiba mohamed6@gmail.com</p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-patient">
                        <a href="patient.php" class="non-style-link-menu"><div><p class="menu-text">Elderlies</p></a></div>
                    </td>
                </tr>
            </table>
        </div>
                        ...
                        <tr >
                            ...
                            <td colspan="2" class="nav-bar" >
                                ...
                                <form action="doctors.php" method="post" class="header-search">
                                    ...
                                    <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Caregiver's name or Email" list="caregivers">&nbsp;&nbsp;
